...
return [
    ...
    'database_host_select_help' => 'Select the host database server that this database should be created on.',
    ...
    'concurrent_connections_label' => 'Concurrent Connections',
    ...
    'database_password_note' => 'A username and password for this database will be randomly generated after form submission.',
    'create_database_button' => 'Create Database',
    ...
    'delete_database_button' => 'Delete',
    'database_deleted' => 'Database has been deleted.',
    'password_reset_success' => 'The password for this database has been reset.',
    'password_reset_error' => 'An error occurred while trying to process this request.',
    
    // Startup Management
    'startup_title' => 'Startup',
    'startup_description' => 'Control startup command as well as variables.',
    'startup_command_modification' => 'Startup Command Modification',
    'startup_command_label' => 'Startup Command',
    'startup_command_edit_help' => 'Edit your server\'s startup command here. The following variables are available by default: <code>@{{SERVER_MEMORY}}</code>, <code>@{{SERVER_IP}}</code>, and <code>@{{SERVER_PORT}}</code>.',
    'default_service_start' => 'Default Service Start Command',
    'save_modifications' => 'Save Modifications',
    'service_configuration' => 'Service Configuration',
    'service_configuration_warning' => 'Changing any of the below values will result in the server processing a re-install command. The server will be stopped and will then proceed. If you would like the service scripts to not run, ensure the box is checked at the bottom.',
    'service_configuration_warning_destructive' => '<strong>This is a destructive operation in many cases. This server will be stopped immediately in order for this action to proceed.</strong>',
    'nest_label' => 'Nest',
    ...
    'skip_egg_install_script' => 'Skip Egg Install Script',
    'skip_install_help' => 'If the selected Egg has an install script attached to it, the script will run during install. If you would like to skip this step, check this box.',
    'docker_image_configuration' => 'Docker Image Configuration',
    'docker_image_label' => 'Image',
    'docker_image_custom_placeholder' => 'Or enter a custom image...',
    ...
    'startup_var_startup_command' => 'Startup Command Variable',
    'startup_var_input_rules' => 'Input Rules',
    'select_nest_egg' => 'Select a Nest Egg',
