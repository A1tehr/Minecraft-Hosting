    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">@lang('admin/node.process_manager')</h3>
            </div>
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    <tr>
                        <th>@lang('admin/node.id')</th>
                        <th>@lang('admin/node.server_name')</th>
                        <th>@lang('admin/node.owner')</th>
                        <th>@lang('admin/node.service')</th>
                    </tr>
