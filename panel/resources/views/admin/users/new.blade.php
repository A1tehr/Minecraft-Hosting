        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="username" class="control-label">@lang('admin/user.username')</label>
                        <div>
                            <input type="text" autocomplete="off" name="username" value="{{ old('username') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_first" class="control-label">@lang('admin/user.client_first_name')</label>
                        <div>
                            <input type="text" autocomplete="off" name="name_first" value="{{ old('name_first') }}" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name_last" class="control-label">@lang('admin/user.client_last_name')</label>
                        <div>
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="submit" value="@lang('admin/user.create_user_button')" class="btn btn-success btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
