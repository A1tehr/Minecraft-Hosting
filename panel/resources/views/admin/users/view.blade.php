...
@section('title')
    @lang('admin/user.manage_user', ['username' => $user->username])
@endsection
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('admin/user.identity')</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="registered" class="control-label">@lang('admin/user.username')</label>
                        <div>
                            <input type="text" name="username" value="{{ $user->username }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registered" class="control-label">@lang('admin/user.client_first_name')</label>
                        <div>
                            <input type="text" name="name_first" value="{{ $user->name_first }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registered" class="control-label">@lang('admin/user.client_last_name')</label>
                        <div>
                            <input type="text" name="name_last" value="{{ $user->name_last }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">@lang('admin/user.default_language')</label>
                        <div>
                            ...
                            <p class="text-muted"><small>@lang('admin/user.default_language_help')</small></p>
                        </div>
                    </div>
                </div>
                <div class="box-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" value="@lang('admin/user.update_user')" class="btn btn-primary btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
